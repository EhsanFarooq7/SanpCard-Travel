...
//                 <form onSubmit={handleSubmit} div className="bg-white rounded-3xl shadow-2xl p-8">
...
const QuoteForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault(); // Now this correctly catches the form submit event
        ...
        <section className="py-20 bg-gradient-to-r from-gray-200 to-white-100" id="quote">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-2xl p-8">
                    ...
                    <button
                        type="submit"
                        className="w-full mt-6 px-8 py-4 bg-orange-500 text-white rounded-xl hover:bg-orange-600 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 font-bold text-lg"
                    >
                        Request Free Quote
                    </button>
                </form>
